...
def classify_product_line(filename: str, text: str) -> str:
    ...
    if any(marker in lowered_filename for marker in dot_matrix_filename_markers):
    ...
    if "热敏" in combined or "thermal" in lowered_combined:
        return "thermal_printer"
    if "针" in combined or "dot_matrix" in lowered_combined or "td630" in lowered_combined:
        return "dot_matrix_printer"
