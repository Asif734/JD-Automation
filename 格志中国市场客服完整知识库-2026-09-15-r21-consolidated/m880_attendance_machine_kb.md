...
## 10. 中国市场生命周期与默认包装（2026-09-09）

- 当前售前型号：M880、M880D、T960D、T960S。
- 历史型号：M880B、P960、T960BT、T960T；只能在客户已有机器的售后场景使用历史知识。
- 停产型号：M880A、M880BT、M880DA、M880DT、M880T、M880D-T；不得作为在售型号推荐，维修或配件先转人工核实。
- 默认包装：电源适配器1个、考勤卡50张、机器内预装通用考勤色带1个、挂墙螺丝2颗；额外数量以购买套餐/订单为准。
- 有偿维修参考费80元；远程安装和排障免费。最终保修、维修地址和费用按订单及人工检测确认。
